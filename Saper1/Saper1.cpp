...
public:
	...
	void fill(int px, int py) {
		...
		while (true) {
			...
			// если нет мин рядом то и все соседние через эту же функцию
